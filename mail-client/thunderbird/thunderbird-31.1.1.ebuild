...
MOZCONFIG_OPTIONAL_JIT="disabled"
...
IUSE="bindist crypt hardened jit ldap +lightning +minimal mozdom selinux"
...
src_install() {
	...
	use jit && pax-mark m "${ED}"/${MOZILLA_FIVE_HOME}/{thunderbird-bin,thunderbird}
