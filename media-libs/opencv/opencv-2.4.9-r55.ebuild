...
IUSE="cuda doc +eigen examples ffmpeg gstreamer gtk ieee1394 ipp jpeg jpeg2k opencl openexr opengl openmp pch png +python qt4 qt5 testprograms threads tiff v4l vtk xine"
REQUIRED_USE="
...
src_configure() {
	if use qt4 && use qt5; then
		einfo
		ewarn "qt4 and qt5 are mutually exclusive! Deselect one!"
		die
	fi
	if use openmp; then
