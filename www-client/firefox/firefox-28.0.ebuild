...
IUSE="bindist hardened gstreamer +jit +minimal pgo pulseaudio selinux system-cairo system-icu system-jpeg system-sqlite test"
...
src_configure() {
	...
	# Use full RELRO on hardnened systems
